    ...
    public:
        ...
        */
        void input(){
            ...
            cout<<"\nEnter position name 'striker', 'midfielder', 'defender', 'goalkeeper'\nGame Name: ";
            cin>>game;
        ...
        void output(){
            ...
            cout<<"position prefered==>"<<game<<endl;
...
/*
    * This functions shows all the Players record which we have stored in filess
*/
void showAllRecords(){
...
void countPlayersInGame(){
   ...
   //Contains the list of games available for enrollment
    string games[4]={"striker","defender","midfielder","goalkeeper"};
    string gameName="";
...
void searchInRecords(int choice){
   // char game[12];  //string game
    ...
    switch(choice){
        ...
        case 6: cout<<"Enter Player's postion stiker, defender, midfielder,goalkeeper : ";
                cin>>searchString;
                break;
...
int main(){
    ...
    while(1){
        ...
        cout<<"\n10: Search Players in a specific positions";
        cout<<"\n11: Count the No. of Player in all positions";
